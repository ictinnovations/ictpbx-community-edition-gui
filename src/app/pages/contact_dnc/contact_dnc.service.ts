...
export class ContactDNCService {
  ...
  get_ContactDNCList(pageSize = null, pageIndex = null, filter = null) {
    const headers = new Headers();
    this.app_service.createAuthorizationHeader(headers);
    const options = new RequestOptions({ headers: headers });
    var url5 = this.app_service.apiUrlContactDNC;
    if (pageSize) {
  ...
  gettotalrows() {
    ...
    this.app_service.createAuthorizationHeader(headers);
    const options = new RequestOptions({ headers: headers });
    var url = `${this.app_service.apiUrlContactDNC}?totalrows`;
